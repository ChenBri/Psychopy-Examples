...
expName = 'd'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\chenb\\Desktop\\speed\\d_lastrun.py',
...
trialComponents = [mouse, label_1, label_2]
...
while continueRoutine:
    ...
    # if label_1 is starting this frame...
    if label_1.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        ...
        # add timestamp to datafile
        thisExp.timestampOnFlip(win, 'label_1.started')
        # update status
        label_1.status = STARTED
        label_1.setAutoDraw(True)
    
    # if label_1 is active this frame...
    if label_1.status == STARTED:
        # update params
        pass
    
    # *label_2* updates
    
    # if label_2 is starting this frame...
    if label_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        ...
        # add timestamp to datafile
        thisExp.timestampOnFlip(win, 'label_2.started')
        # update status
        label_2.status = STARTED
        label_2.setAutoDraw(True)
    
    # if label_2 is active this frame...
    if label_2.status == STARTED:
        # update params
        pass
