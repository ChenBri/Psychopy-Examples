...
expName = 'rsitsr'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\chenb\\Desktop\\Repeat Sound in the same routine\\rsitsr_lastrun.py',
