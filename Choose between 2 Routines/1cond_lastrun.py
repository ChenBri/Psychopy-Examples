...
expName = '1cond'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\chenb\\Desktop\\1cond_lastrun.py',
...
gotValidClick = False  # until a click is received
# keep track of which components have finished
Experiment1Components = [text_2, mouse]
...
thisExp.nextEntry()
# the Routine "Experiment1" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()
...
gotValidClick = False  # until a click is received
# keep track of which components have finished
Experiment2Components = [text_3, mouse_3]
